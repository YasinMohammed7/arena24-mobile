  ...
  ios: {
    ...
    infoPlist: {
      ...
      NSCameraUsageDescription:
        "Această aplicație folosește camera pentru a scana codurile QR de pe mese.",
      NSPhotoLibraryUsageDescription:
        "Această aplicație folosește galeria foto pentru a schimba poza de profil.",
    },
    associatedDomains: ["applinks:arena-24.expo.app"],
  },
  android: {
    intentFilters: [
      {
